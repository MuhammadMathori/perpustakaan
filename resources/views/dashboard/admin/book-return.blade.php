        ...
        <form action="bookReturn" method="POST">
            ...
            <div class="col-12 col-md-8 offset-md-2 col-lg-6 offset-md-3 mt-5">
                ...
                <div class="mt-4">
                    ...
                    <h3 class="mb-4 text-center">Book Return Form</h3>
                    <div class="mb-3">
                        <select class="form-select userBox" aria-label="Default select example" name="user_id"
                            id="user">
                    ...
                    <div class="mb-3">
                        <select class="form-select bookBox" aria-label="Default select example" name="book_id"
                            id="book">
